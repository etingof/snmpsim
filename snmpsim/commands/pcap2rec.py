...
#
# SNMP Simulator packet capture to data file converter
#
import bisect
import getopt
import os
...
""" % (snmpsim.__version__,
    ...
    if not pcap:
        sys.stderr.write(
            ...
            '`pip install https://downloads.sourceforge.net/project/'
            'pylibpcap/pylibpcap/0.6.4/pylibpcap-0.6.4.tar.gz`'
            '\r\n%s\r\n' % helpMessage)
        return 1
